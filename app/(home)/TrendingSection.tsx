    ...
    <View style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <View style={styles.titlePill}>
          <Text style={styles.titleText}>Trending Jobs</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  titleContainer: {
    alignItems: 'center',
    marginBottom: 32, // Extra margin to accommodate the overlapping badge
  },
  titlePill: {
  ...
  card: {
    backgroundColor: '#E6F0FE', // Light blue background from image
    borderRadius: 12,
    padding: 20,
    position: 'relative',
    marginTop: 10, // Margin to make room for badge to break out top
  },
  daysLeftBadge: {
    position: 'absolute',
    top: -16,
    ...
    borderRadius: 8,
    gap: 6,
    // Subtle shadow for the overlapping badge
    shadowColor: '#000',
  ...
  applyButton: {
    flex: 1,
    backgroundColor: '#2563EB', // Deeper blue from image
    borderRadius: 8,
    paddingVertical: 12,
    alignItems: 'center',
    justifyContent: 'center',
